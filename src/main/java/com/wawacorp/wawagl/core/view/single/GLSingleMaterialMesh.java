...
public class GLSingleMaterialMesh extends GLMesh {
    private String name;
    ...
    public GLSingleMaterialMesh(Mesh mesh) {
        this(mesh, new Entity());
    }

    public GLSingleMaterialMesh(Mesh mesh, Entity entity) {
        this(mesh, entity, Material.DEFAULT);
    }

    public GLSingleMaterialMesh(Mesh mesh, Entity entity, Material material) {
        this(mesh, entity, material, Shader.getMaterialShader());
    }

    public GLSingleMaterialMesh(Mesh mesh, Entity entity, Material material, Shader shader) {
        super(mesh);
