...
public class GLMultipleMesh extends GLMesh implements Observer {
    private InstancedVAO vertexArray;
    private IndexBufferObject indexBuffer;
    private Material material;
    private final Instance[] instances;

    public GLMultipleMesh(Mesh mesh, Shader shader, Instance[] instances) {
        super(mesh);
    ...
    public void draw() {
        bind();
        glDrawElementsInstanced(GL_TRIANGLES, indexCount, GL_UNSIGNED_INT, 0, instances.length);
        unbind();
    }
