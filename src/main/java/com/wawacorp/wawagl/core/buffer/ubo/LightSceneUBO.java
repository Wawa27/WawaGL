...
public class LightSceneUBO extends BufferObject {
    ...
    public void updatePointLight(int lightOffset) {
        ...
        Vector4f position = new Vector4f(lightScene.getPointLights().get(lightOffset).getPosition());
        position.mul(Camera.ACTIVE.getNormalMatrix(lightScene.getDirectionalLights().get(lightOffset).getModelMatrix()));
    ...
    public void updateDirectionalLight(int lightOffset) {
        ...
        direction.mul(Camera.ACTIVE.getNormalMatrix(lightScene.getDirectionalLights().get(lightOffset).getModelMatrix()));
    ...
    public void updateSpotLight(int lightOffset) {
        ...
        Vector4f position = new Vector4f(lightScene.getSpotLights().get(lightOffset).getPosition());
